...
手感参数除在 `player.gd` 中保留 `@export` 默认值外，**集中管理在 `docs/player_params.csv`**：
...
> 参考：`docs/CelestePlayerReference.txt` 的 `DashCoroutine`(3548) / `DashUpdate`(3474) / `SuperJump`(1695) / `OnCollideV`(2504)。
